      ...
      if (
        ...
        Xe
          ...
          : O.autoplayButtonOutput &&
            (j.insertAdjacentHTML(cn(O.autoplayPosition), '<button data-action="' + t + '">' + Ke[0] + t + Ke[1] + At[0] + "</button>"), (Xe = j.querySelector("[data-action]"))),
          Xe && ea(Xe, { click: yi }),
        ...
        if ("prev" === t) fi(e, -1);
          ...
          if (
            ("first" === t
              ...
              : "last" === t
              ? (i = I ? K - ft - n : K - 1 - n)
              : ("number" != typeof t && (t = parseInt(t)), isNaN(t) || (e || (t = Math.max(0, Math.min(K - 1, t))), (i = t - n))),
            !I && i && Math.abs(i) < ft)
          ) {
            var a = 0 < i ? 1 : -1;
